        ...
        <form @submit.prevent="handleSubmit" class="form-container mt-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="addressLine1" v-model="carPark.addressLine1"
                                required>
                        </div>
                        <div class="col-md-6">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <input type="number" class="form-control" id="totalBays" v-model.number="totalBays"
                        @input="updateBays" required>
                </div>
            </div>
                ...
                <div v-for="(bay, index) in carPark.bays" :key="index" class="col-md-6 mb-4">
                    <div class="card h-100 text-center p-2">
                        <div class="card-body">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" v-model="bay.disabled"
                                    :id="'disabled' + index">
                        ...
                        <div class="card-body">
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" :placeholder="`£${getDefaultPrice(pricing)}`"
                                    ...
                                    v-model.number="carPark.pricing[pricing.toLowerCase()]" step="0.01" min="0">
                            </div>
                        </div>
                    </div>
                </div>
...
import { fetchCarParkDetails, adminUpdateCarPark } from '@/services/carParkService';
...
export default {
    setup() {
        ...
        async function handleSubmit() {
            ...
            try {
                await adminUpdateCarPark(carparkId, carPark);
